  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-[#050510] overflow-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 z-0">
        <div className="absolute top-[-20%] left-[-10%] h-[600px] w-[600px] rounded-full bg-[#f59e0b]/15 blur-[120px] animate-float" />
        <div className="absolute bottom-[-10%] right-[-5%] h-[500px] w-[500px] rounded-full bg-[#ef4444]/12 blur-[120px] animate-float-delayed" />
      </div>
      ...
      <main className="relative z-10 flex flex-1 w-full max-w-5xl mx-auto flex-col items-center px-6 pt-10 pb-16">
        ...
        <div className="mb-10 text-center animate-fade-in-up">
          <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-white/[0.08] bg-white/[0.03] px-4 py-1.5 text-sm text-white/50 backdrop-blur-sm">
            ...
            Decentralized &middot; Permissionless &middot; On-chain
          </div>
          ...
          <h1 className="mb-3">
            <span className="block text-4xl sm:text-5xl font-bold tracking-tight leading-[1.1]">
              ...
              <span className="bg-gradient-to-r from-[#f59e0b] via-[#fb923c] to-[#ef4444] bg-[length:200%_auto] animate-gradient-shift bg-clip-text text-transparent">
                Lottery
              </span>
            </span>
          </h1>
          ...
          <p className="mx-auto max-w-lg text-sm sm:text-base leading-relaxed text-white/40">
            A fully permissionless lottery on Stellar. Anyone can enter, anyone can draw, and everyone can verify — no admins, no owners, just code.
          </p>
        ...
        <div className="mt-10 flex flex-col items-center gap-4 animate-fade-in">
          ...
          <div className="flex items-center gap-3 text-xs text-white/20">
            {["Enter", "Wait ~5min", "Anyone Draws", "Winner Paid"].map((step, i) => (
